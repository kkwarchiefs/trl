...
class PPOTrainer(BaseTrainer):
    ...
    def prepare_logit_inputs(self, queries_t, responses_t, queries, responses):
        ...
        for query, response in zip(queries, responses):
            ...
            ge_inputs = self.tokenizer.build_inputs_for_generation(inputs, targets=response, max_gen_length=max_length+6, padding=True)
    ...
    def batched_forward_pass(
        ...
        for i in range(int(bs / fbs)):
            print("input_kwargs keys:", model_inputs)
